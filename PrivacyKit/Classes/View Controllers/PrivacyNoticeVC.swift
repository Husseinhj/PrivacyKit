...
open class PrivacyNoticeVC: UIViewController, UITextViewDelegate {
    ...
    internal func addDefaultView() {
        ...
        titleLabel.textAlignment = PrivacyKit.shared.style.alignment
        descriptionTextView.textAlignment = PrivacyKit.shared.style.alignment
        
        titleLabel.font = PrivacyKit.shared.style.titleFont
        descriptionTextView.font = PrivacyKit.shared.style.messageFont
        
        denyButton.titleLabel?.font = PrivacyKit.shared.style.buttonFont
        acceptButton.titleLabel?.font = PrivacyKit.shared.style.buttonFont
        
        denyButton.setTitle(PrivacyKit.shared.style.denyTitle, for: .normal)
        acceptButton.setTitle(PrivacyKit.shared.style.acceptTitle, for: .normal)
